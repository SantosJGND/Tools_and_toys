...
def KDE_windows(Windows,label_vector,ref_labels,Out,Comparison_threshold= 4,Outlier_threshold= 1e-3):
    ...
    color_ref= ['yellow','blue','black','green','orange','purple','green','silver','red3','deepskyeblue','navy','chartreuse','darkorchid3','goldenrod2']
    ...
    fig= return_ideogram(ideo_kde,chromosome_list,ID)
